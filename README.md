...
`target/wasm32-wasip2/release/component_adaptive_card.wasm`. Update the manifest hash by
running `greentic-component inspect --json target/wasm32-wasip2/release/component_adaptive_card.wasm`.
